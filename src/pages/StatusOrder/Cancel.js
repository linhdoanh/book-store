...
export default function CancelPage() {
  ...
  const handleChangeStatusToCancel = async () => {
    const response = await fetch('https://localhost:44301/api/orders/order/order-status/cancel?orderId='+ordId, {
      method: 'PUT',
            ...
            <TableContainer sx={{ minWidth: 800 }}>
              <Table>
                ...
                <TableBody>
                  ...
                  <TableRow>
                    <TableCell>
                      <Button onClick={handleChangeStatusToCancel}>Cancel</Button>
                    </TableCell>
                    <TableCell>
